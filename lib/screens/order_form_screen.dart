...
class _OrderFormScreenState extends State<OrderFormScreen> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildVerticalInputGroup(
              '床板',
              _buildLabeledTextField('床板', 'floorBoardThickness', _floorBoardThicknessController, keyboardType: TextInputType.number, unit: 'mm', showLabel: false),
            ),
            ...
            _buildRadioGroup("計算方法", "loadCalculationMethod", _loadCalculationMethod, ['等分布荷重', '中央集中荷重', '2点集中荷重'], (val){
                setState(() => _loadCalculationMethod = val); _triggerAllCalculations();
            }),
  ...
  Widget _buildDimensionWithCheckbox(
    ...
    String key2, TextEditingController dim2Ctrl,
    String checkboxLabel, bool checkboxValue, ValueChanged<bool?> onChanged
  ) {
    return _buildVerticalInputGroup(label, Row(
        children: [
          Expanded(flex: 2, child: _buildDoubleInputRowWithUnit(key1, dim1Ctrl, '幅', key2, dim2Ctrl, '厚さ')),
          const SizedBox(width: 8),
