    ...
    pw.Widget _buildDrawing(Uint8List? imageBytes, String placeholder) {
      return pw.Container(
          ...
          child: imageBytes != null
              ...
              : pw.Center(child: pw.Text(placeholder, style: mainTextStyle)), // 修正: mainTextStyle を使用
        );
    }
        ...
        child: pw.RichText(
          text: pw.TextSpan(
            children: [
              pw.TextSpan(
                text: '$label:',
                style: mainTextStyle.copyWith( // 修正: mainTextStyle を使用
              ...
              child: pw.RichText(
                text: pw.TextSpan(
                  children: [
                    ...
                    pw.TextSpan(text: '${data.floorBoardThickness}', style: textStyle.copyWith(fontWeight: pw.FontWeight.bold)),
                  ]
                )
              ),
            ),
